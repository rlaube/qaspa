...
DATASET_LIST = ['csqa', 'obqa', 'socialiqa', 'medqa']
...
def add_data_arguments(parser):
    ...
    parser.add_argument('--cpnet_emb_path', default='data/cpnet/normalized_cpnet_vocab_sp_QA.pkl', help='path for concept/relation embeddings')
    # parser.add_argument('--emb_dict_path', default='data/cpnet/normalized_cpnet_vocab_sp_QA.pkl', help='path to cpnet + relations sps (pkl)')
    # parser.add_argument('--emb_map_path', default='data/cpnet/cpnet_vocab_map.pkl', help='path to cpnet vocab map')
    # dataset specific
...
def add_optimization_arguments(parser):
    ...
    parser.add_argument('--lr_schedule', default='fixed', choices=['fixed',' warmup_cosine', 'warmup_cosine_restarts' , 'warmup_poly', 'warmup_linear', 'warmup_constant'], help='learning rate scheduler')
    parser.add_argument('--power', default=2, type=int)
    parser.add_argument('--cycles', default=1.0, type=float)
